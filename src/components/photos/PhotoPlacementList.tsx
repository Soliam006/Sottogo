 ...
 *
 * Se distingue el caso de la guarda de privacidad del de la foto sin datos: son
...
function sinUbicacion(propio: PlacedFile | undefined): string {
  if (propio?.reason === "fuera-del-viaje") {
    return "Es de fuera de las fechas del viaje: no se sitúa sola";
  }
  return "La foto no lleva ubicación";
}
